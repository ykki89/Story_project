        ...
        <div class="wrapper">
            <div class="product_link_tap flex-wrap-nav">
                <ul class="list_margin_btm">
                    <li><a href="PC_LI_09.do">축산물</a></li>
                    <li class="on"><a href="PC_LI_10.do">가금류</a></li>
            ...
            <div class="wrapper">
                    <ul>
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img73.jpg" alt="추천 이미지1">  
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[충남 청양] 동물복지 인증 생닭</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img74.jpg" alt="추천 이미지2">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[경기 양평] 논에서 키운 오리</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img75.jpg" alt="추천 이미지3">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[경기 여주] 별미로 맛보는 칠면조</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img76.jpg" alt="추천 이미지4">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[전북 무주] 청정산악에서 자란 오리</p>
                                    </p>
            ...
            <div class="good_product">
                <div class="wrapper">
                        <ul>
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img77.jpg" alt="추천 이미지5">  
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[경기 화성] 직송, 메추라기</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img78.jpg" alt="추천 이미지6">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[충북 괴산] 직송으로 즐기는 꿩</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img79.jpg" alt="추천 이미지7">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[전북 익산] 부드러운 토종 닭</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img80.jpg" alt="추천 이미지8">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[경남 하동] 다이어터의 닭가슴살</p>
                                        </p>
