        ...
        <div class="wrapper">
            <div class="product_link_tap flex-wrap-nav">
                <ul class="list_margin_btm">
                    ...
                    <li class="on"><a href="PC_LI_08.do">해조류</a></li>
                </ul>
            ...
            <div class="wrapper">
                    <ul>
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img57.jpg" alt="추천 이미지1">  
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[전남 무안] 마른 다시마 산지직송</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img58.jpg" alt="추천 이미지2">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[전남 영광] 산지직송 미역</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img59.jpg" alt="추천 이미지3">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[전남 진도] 남도의 별미, 톳</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img60.jpg" alt="추천 이미지4">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[전남 완도] 세계인이 사랑하는 김</p>
                                    </p>
            ...
            <div class="good_product">
                <div class="wrapper">
                        <ul>
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img61.jpg" alt="추천 이미지5">  
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[전남 진도] 재래김, 고소한 맛</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img62.jpg" alt="추천 이미지6">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[전남 완도] 고급 김, 완도 곱창김</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img63.jpg" alt="추천 이미지7">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[전남 여수] 돌산 김</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img64.jpg" alt="추천 이미지8">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[전남 완도] 청정해역의 보길도 김</p>
                                        </p>
