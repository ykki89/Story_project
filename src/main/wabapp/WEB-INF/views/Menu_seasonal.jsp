...
<body>
    ...
    <div class="main_picture">
        <div class="wrapper">
            <img src="images/seasonal-01.png" width="1400px">
        </div>
    </div>
    <div class="title">
        <div class="wrapper">
            <img src="images/seasonal-02.png" width="1400px">
        </div>
    </div>
    <div class="season_story">
        <div class="wrapper">
            <ul class="img_wrap_banner">
                <li><a href="#"><img src="images/seasonal-03.png"></a></li>
                <li><a href="#"><img src="images/seasonal-04.png"></a></li>
                <li><a href="#"><img src="images/seasonal-05.png"></a></li>
                <li><a href="#"><img src="images/seasonal-06.png" ></a></li>
            </ul>
        </div>    
    </div>
    <div class="season_story">
        <div class="wrapper">
            <ul class="img_wrap_banner">
                <li><a href="#"><img src="images/seasonal-07.png"></a></li>
                <li><a href="#"><img src="images/seasonal-08.png"></a></li>
                <li><a href="#"><img src="images/seasonal-09.png"></a></li>
                <li><a href="#"><img src="images/seasonal-10.png" ></a></li>
            </ul>
        </div>    
    </div>
