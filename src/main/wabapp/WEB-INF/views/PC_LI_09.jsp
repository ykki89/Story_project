        ...
        <div class="wrapper">
            <div class="product_link_tap flex-wrap-nav">
                <ul class="list_margin_btm">
                    <li class="on"><a href="PC_LI_09.do">축산물</a></li>
                    <li><a href="PC_LI_10.do">가금류</a></li>
                    <li><a href="PC_LI_11.do">계란류</a></li>
                    <li><a href="PC_LI_12.do">유제품</a></li>
                </ul>
            ...
            <div class="wrapper">
                    <ul>
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img65.jpg" alt="추천 이미지1">  
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[경북 의성] 무항생제 삼겹살</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img66.jpg" alt="추천 이미지2">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[강원 횡성] 동물복지 인증, 꽃등심</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img67.jpg" alt="추천 이미지3">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[경기 포천] 신선한 직송 목살</p>
                                    </p>
                        ...
                        <li class="list_margin_btm">
                            <a href="#">
                                <img src="images/good_pr_img68.jpg" alt="추천 이미지4">
                                <div class="good_info">
                                    <p class="product_name">
                                        <p class="product_txt gray_txt middle_txt">[강원 원주] 고소한 맛, 항정살</p>
                                    </p>
            ...
            <div class="good_product">
                <div class="wrapper">
                        <ul>
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img69.jpg" alt="추천 이미지5">  
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[충남 서산] 신선하게 맛보는 차돌</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img70.jpg" alt="추천 이미지6">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[경기 평택] 저렴하게 즐기는 뒷다리</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img71.jpg" alt="추천 이미지7">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[강원 횡성] 한우로 즐기는 스테이크</p>
                                        </p>
                            ...
                            <li class="list_margin_btm">
                                <a href="#">
                                    <img src="images/good_pr_img72.jpg" alt="추천 이미지8">
                                    <div class="good_info">
                                        <p class="product_name">
                                            <p class="product_txt gray_txt middle_txt">[강원 횡성] 청정한우, 횡성 한우등심</p>
                                        </p>
