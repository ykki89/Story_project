...
<body>
        ...
        <div class="wrapper prdouct_wrapper">       
                    <div class="left_content">
                        <div class="product_img" >
                            <img src="images/product_img_04.jpg" class="align-right">
                        </div>
                    </div>
                    <div class="right_content">
                        <div class="product_info">
                            <p class="header_txt display_block">[전남 해남] 포근한 기후의 해남에서 만나는 호박고구마 3kg</p>
                            <p class="note_txt display_block">해풍이 해남땅과 만나 수확때까지 포근함을 선사하며 달콤함을 더해주는 호박고구마 산지 직송</p>
                        ...
                        <form action="#" method="post">
	                        ...
	                        <c:choose>
		                        <c:when test="${sessionScope.userId == null || sessionScope.userId == '' }">
		                    		<input type="button" class="btn btn_type2 lg_btn" value="주문하기" onclick="location.href = 'login.do'">
		                        	<input type="button" class="btn btn_type1 lg_btn" value="장바구니 담기" onclick="location.href = 'login.do'">
		                        </c:when>
		                        <c:otherwise>
		                      		<input type="button" class="btn btn_type2 lg_btn" value="주문하기" onclick="location.href='PC_OR_01.do'">
		                      		<input type="button" class="btn btn_type1 lg_btn" value="장바구니 담기" onclick="location.href='shoppingBasket.do'">           
		                        </c:otherwise>
	                    	</c:choose>		
                            </div>
                        </div>
    ...
    <div class="product_intro">
        <div class="wrapper">
                <div class="view_product_information_group align-left">
                    <ul>
                        <li><a href="#" class="human_letter product_txt">상품설명</a></li>
                    </ul>
                </div>
                <div class="product_description">
                    <!-- 내용 또는 이미지 -->
                    <img src="images/detail_story_img_04.jpg">
                </div>
        </div>
    </div>
